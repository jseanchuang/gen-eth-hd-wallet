 ...
 */
 ...
 /**
  * This demonstration calculates the keys for wallets implementing BIP-44, 
  * where path is defined as: where path is defined as: 
  * m/purpose'/coin_type'/account'/change/address_index defined
  * 
  * The output address was generated by derivePath: m/44'/60'/0'/0/0.
  */
function main() {
    ...
    /**
     * Generate ETH address by given derive path
     */
    const derivePath = "m/49'/60'/0'/0/0";
